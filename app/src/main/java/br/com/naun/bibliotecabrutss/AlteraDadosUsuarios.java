...
public class AlteraDadosUsuarios extends AppCompatActivity {
    EditText livro;
    EditText autor;
    EditText editora;
    Button alterar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        livro = (EditText)findViewById(R.id.txtNome);
        autor = (EditText)findViewById(R.id.txtEmail);
        editora = (EditText)findViewById(R.id.Email);
        ...
        alterar.setOnClickListener (new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AlteraDadosUsuarios.this,ConsultaDados.class);
